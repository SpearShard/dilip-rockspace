...
export const projects: Project[] = [
  ...
  {
    id: '002',
    title: 'RGB Design / Generative Color',
    subtitle: 'Design System Exploration',
    category: 'BRAND',
    description: 'Generative color system that creates dynamic brand palettes from audio input. A living design tool for creative teams.',
  },
  {
    id: '003',
    title: 'Fluid UI / Motion System',
    subtitle: 'Interface Motion Language',
    category: 'MOTION',
  ...
  },
  {
    ...
    subtitle: 'Data-Driven Product UI',
    category: 'DATA',
    description: 'AI-powered skills intelligence platform with complex data viz, real-time workforce analytics, adaptive interface.',
  },
  {
    id: '006',
    title: 'Spatial Interfaces',
    subtitle: '3D/VR Interface Exploration',
    category: 'VR',
